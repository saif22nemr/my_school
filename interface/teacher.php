<?php
session_start();
if(!(isset($_SESSION['Username1']) && isset($_SESSION['GroupID1']) && $_SESSION['GroupID1'] == 2)){
        ...
        <div class="timetable">  
         ...
         <div class="desc_sec degree degree_table" <?php if(isset($do)) echo $val;?> id="degree" >
            <h1 class="text-center">الدرجات</h1>
             ...
             $academic = selectData('*','academic_year','1 order by aid desc limit 1');
             if ($academic != false){
                 $nameDegree = selectData('*','reg_teacher,degreetype,course','rtteacherId='.$id.' and dtcourseId=rtcourseId and dtcourseId=cid and dtacademicYear='.$academic[0].' order by cid',1);
                 
                 ?>
             <div class="filter row" style="display:block">
...
<script src="layout/js/main1.js"></script>
    </body>
</html>